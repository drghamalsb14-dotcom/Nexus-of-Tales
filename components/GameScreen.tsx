...
const GameScreen: React.FC<GameScreenProps> = ({ storyTitle, scene, onSelectChoice, onBackToMenu, uiText }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-4 animate-fade-in">
      ...
      <div className="w-full max-w-3xl bg-black bg-opacity-30 backdrop-blur-sm rounded-lg shadow-2xl shadow-black/50 p-6 md:p-10 border border-gray-700">
